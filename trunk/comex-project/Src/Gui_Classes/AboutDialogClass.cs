...
namespace comex
{
	...
	public class AboutDialogClass
	{
		...
		{
			// Set dialog icon
            AboutDialog.Icon = Gdk.Pixbuf.LoadFromResource("comex.Resources.Images.comex_256.png");
            ...
            imgLogo.Pixbuf = Gdk.Pixbuf.LoadFromResource("comex.Resources.Images.comex_32.png");
